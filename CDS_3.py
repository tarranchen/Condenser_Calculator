...
def calculate():
    ...
    try:
        ...
        if not (a > 0 and L > 0 and distance > 0):
            messagebox.showerror("參數錯誤", "橢圓半長軸a, Condenser長度Length, 波帶片樣品距離Distance 皆必須大於 0")
            clear_results()
            return
        if not (0 < na1 < 1):
...
ttk.Label(frame_input, text="橢圓半長軸a (mm):").grid(row=0, column=0, sticky="w", pady=5, padx=5)
entry_a = ttk.Entry(frame_input, width=18)
entry_a.insert(0, "950")
entry_a.grid(row=0, column=1, pady=5, padx=5)

ttk.Label(frame_input, text="Condenser長度Length (mm):").grid(row=1, column=0, sticky="w", pady=5, padx=5)
entry_L = ttk.Entry(frame_input, width=18)
entry_L.insert(0, "120")
entry_L.grid(row=1, column=1, pady=5, padx=5)

ttk.Label(frame_input, text="波帶片樣品距離Distance (mm):").grid(row=2, column=0, sticky="w", pady=5, padx=5)
entry_distance = ttk.Entry(frame_input, width=18)
entry_distance.insert(0, "50")
entry_distance.grid(row=2, column=1, pady=5, padx=5)

ttk.Label(frame_input, text="外數值孔徑NA1 (rad):").grid(row=3, column=0, sticky="w", pady=5, padx=5)
entry_na1_in = ttk.Entry(frame_input, width=18)
entry_na1_in.insert(0, "0.003")
entry_na1_in.grid(row=3, column=1, pady=5, padx=5)

ttk.Label(frame_input, text="入口半徑Entrance R (mm):").grid(row=4, column=0, sticky="w", pady=5, padx=5)
entry_r_in_in = ttk.Entry(frame_input, width=18)
entry_r_in_in.insert(0, "0.5")
entry_r_in_in.grid(row=4, column=1, pady=5, padx=5)
...
ttk.Label(frame_output, text="橢圓半短軸b (mm):").grid(row=0, column=0, sticky="w", pady=5, padx=5)
lbl_b_val = ttk.Label(frame_output, text="---", font=("Consolas", 10))
lbl_b_val.grid(row=0, column=1, sticky="w", pady=5, padx=5)

ttk.Label(frame_output, text="工作距離WD (mm):").grid(row=1, column=0, sticky="w", pady=5, padx=5)
lbl_wd_val = ttk.Label(frame_output, text="---", font=("Consolas", 10))
lbl_wd_val.grid(row=1, column=1, sticky="w", pady=5, padx=5)

ttk.Label(frame_output, text="內數值孔徑NA2 (rad):").grid(row=2, column=0, sticky="w", pady=5, padx=5)
lbl_na2_val = ttk.Label(frame_output, text="---", font=("Consolas", 10))
lbl_na2_val.grid(row=2, column=1, sticky="w", pady=5, padx=5)

ttk.Label(frame_output, text="出口半徑Exit R (mm):").grid(row=3, column=0, sticky="w", pady=5, padx=5)
lbl_r_out_val = ttk.Label(frame_output, text="---", font=("Consolas", 10))
lbl_r_out_val.grid(row=3, column=1, sticky="w", pady=5, padx=5)

ttk.Label(frame_output, text="環寬Width:").grid(row=4, column=0, sticky="w", pady=5, padx=5)
lbl_width_val = ttk.Label(frame_output, text="---", font=("Consolas", 10))
lbl_width_val.grid(row=4, column=1, sticky="w", pady=5, padx=5)
...
ttk.Label(frame_remarks, text="(二次)光源距樣品 (mm):").grid(row=0, column=0, sticky="w", pady=5, padx=5)
lbl_source_dist_val = ttk.Label(frame_remarks, text="---", font=("Consolas", 10))
lbl_source_dist_val.grid(row=0, column=1, sticky="w", pady=5, padx=5)
...
lbl_zp_diam_val.grid(row=1, column=1, sticky="w", pady=5, padx=5)

ttk.Label(frame_remarks, text="波帶片Central Stop直徑 (μm):").grid(row=2, column=0, sticky="w", pady=5, padx=5)
lbl_cs_diam_val = ttk.Label(frame_remarks, text="---", font=("Consolas", 10))
lbl_cs_diam_val.grid(row=2, column=1, sticky="w", pady=5, padx=5)
...
lbl_source_size_val.grid(row=3, column=1, sticky="w", pady=5, padx=5)

ttk.Label(frame_remarks, text="Beam Stop直徑 (μm):").grid(row=4, column=0, sticky="w", pady=5, padx=5)
lbl_bs_diam_val = ttk.Label(frame_remarks, text="---", font=("Consolas", 10))
lbl_bs_diam_val.grid(row=4, column=1, sticky="w", pady=5, padx=5)
